namespace Recipe.Views
{
    ...
    public partial class ModernRemarksButton : ModernButton
    {
        ...
        public ModernRemarksButton() : base()
        {
        }
        ...
        {
            Font = string.IsNullOrEmpty(remarks) ? new Font(Font, FontStyle.Regular) : new Font(Font, FontStyle.Bold);
